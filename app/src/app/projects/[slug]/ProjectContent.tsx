                    ...
                    >
                        {project.link && (
                            <a
                                ...
                                className="px-8 py-4 rounded-full bg-primary text-white font-bold hover:bg-primary-soft transition-all hover:scale-105 shadow-[0_0_20px_rgba(249,115,22,0.4)]"
                            >
                                Visit Live Site
                            </a>
                        )}
                        {project.githubUrl && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-8 py-4 rounded-full bg-white/10 text-white font-bold hover:bg-white/20 transition-all hover:scale-105 backdrop-blur-sm"
                            >
                                View Code
                            </a>
                        )}
