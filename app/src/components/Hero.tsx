...
/**
 * @file Hero.tsx
 * @description Editorial hero section: name, a short statement, and CTAs.
 */
    ...
    return (
        <Section id="hero" className="pt-36 md:pt-48 pb-24 min-h-[90vh] flex flex-col justify-center relative">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center relative z-10">
                ...
                >
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-8 text-foreground leading-tight">
                        Robin Morgenstern<span className="text-primary">.</span>
                    </h1>
                    ...
                    <div className="mt-8 flex flex-wrap items-center gap-3">
                        ...
                        <a
                            ...
                            className="flex items-center justify-center h-12 px-6 font-medium text-foreground-muted transition-all duration-300 rounded-lg border border-border hover:border-primary/30 hover:text-foreground hover:bg-surface active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                        >
                        ...
                        <a
                            ...
                            className="flex items-center justify-center h-12 w-12 text-foreground-muted transition-all duration-300 rounded-lg border border-border hover:border-primary/30 hover:text-foreground hover:bg-surface active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                ...
                >
                    <div className="relative w-64 h-80 md:w-72 md:h-96">
                        <div className="absolute inset-0 rounded-2xl overflow-hidden border border-border bg-background-secondary">
                            <Image
