...
export const aboutContent: AboutContent = {
    ...
    bio: [
        ...
        "As an independent developer, I build and run complete products. HideZone, my real-time GPS multiplayer game, has reached more than 50,000 downloads across Google Play and the App Store. I have also delivered remote desktop and virtual-machine support tools for enterprise clients.",
