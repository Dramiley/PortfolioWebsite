...
export const aboutContent: AboutContent = {
    ...
    bio: [
        ...
        "The freelance side is where things get shipped. Most recently that was HideZone, a real-time GPS hide-and-seek game that has passed 25,000 downloads on the App Store and Google Play, and before that a remote desktop client with time-linked authentication for an enterprise customer.",
