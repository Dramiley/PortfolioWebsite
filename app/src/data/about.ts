...
export const aboutContent: AboutContent = {
    ...
    bio: [
        ...
        "As a freelancer, I enjoy turning ideas into real products. Recently, I built and shipped HideZone, a real-time GPS game with over 400 active players, and delivered a secure remote desktop client for a business customer.",
