...
export const aboutContent: AboutContent = {
    ...
    bio: [
        ...
        "As a freelancer, I enjoy turning ideas into real products. Recently, I built and shipped HideZone, a real-time GPS game with over 5000 downloads across the Play Store and App Store, and delivered a secure remote desktop client for a business customer.",
